            ...
            <div className="grid-66">
              <div className="course--header">
                ...
                <div><input id="title" name="title" type="text" className="input-title course--title--input" placeholder="Course title..."
                    value="Build a Basic Bookcase" readOnly /></div>
                <p>By Joe Smith</p>
              </div>
                ...
                <ul className="course--stats--list">
                  <li className="course--stats--list--item">
                    ...
                    <div><input id="estimatedTime" name="estimatedTime" type="text" className="course--time--input"
                        placeholder="Hours" value="14 hours" readOnly /></div>
                  </li>
                  <li className="course--stats--list--item">
...
* Minwax Oil Based Polyurethane
            ...
            <div className="grid-100 pad-bottom"><button className="button" type="submit">Update Course</button><button className="button button-secondary" onClick={() => console.log('Something Else Happens Here')}>Cancel</button></div>
          </form>
        </div>
      </div>
    </div>
